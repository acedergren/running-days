 ...
 * Extracted from webhook endpoint for testability
 */
 ...
 */
export function aggregateDailyStats(workouts: ProcessedWorkout[]): DailyStatsUpdate | null {
...
export function mergeDailyStats(
	...
	return {
		...
		longestRunMeters: Math.max(existing.longestRunMeters, newWorkout.distanceMeters),
		fastestPaceSecondsPerKm: fastestPace
	};
}
